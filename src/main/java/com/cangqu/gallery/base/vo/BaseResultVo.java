 ...
 *
 */
@ApiModel(value = "A single person", description = "This is a test model that represents a person", discriminator = "")
public class BaseResultVo implements Serializable
{
    ...
    // 返回码，0表示成功，非0表示失败
    @ApiModelProperty(value = "返回码，0表示成功，非0表示失败", notes = "The first and last name of this person", required = true)
