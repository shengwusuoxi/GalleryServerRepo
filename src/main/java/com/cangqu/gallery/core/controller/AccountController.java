...
public class AccountController extends BaseController {
    ...
    @ResponseBody
    public String register(@RequestParam(value = "username") String userName, @RequestParam String password) {
    ...
    @ResponseBody
    public String login(@RequestParam(value = "username") String userName, @RequestParam String password) {
        LOGGER.debug("username:" + userName + "pwd:" + password);
        Condition condition = new QuickCondition(User.class);
        condition.addEqual("username", userName);
        List<User> userList = userService.findByCondition(condition, null);
